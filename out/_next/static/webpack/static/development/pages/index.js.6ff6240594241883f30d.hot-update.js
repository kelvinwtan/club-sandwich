...
const SandwichGenerator = () => {
  ...
  const getRandomSpeech = name => {
    const speeches = ["yum yum i love the sandwiches at ".concat(name), 'who needs pilot when i have sandwich club', 'yum yum in my tum tum', "".concat(name, " is the shit")];
...
//# sourceMappingURL=index.js.6ff6240594241883f30d.hot-update.js.map