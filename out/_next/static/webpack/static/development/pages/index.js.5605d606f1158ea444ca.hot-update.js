...
const SandwichGenerator = () => {
  ...
  const getRandomSpeech = name => {
    const speeches = ["yum yum i love the sandwiches at ".concat(name), 'mmmmmmmmmm!'];
    return speeches[Math.floor(speeches.length * Math.random())];
  };
  ...
  const setRandomPlace = () => {
    ...
    const msg = new SpeechSynthesisUtterance("yum yum i love the sandwiches at ".concat(place.name));
...
//# sourceMappingURL=index.js.5605d606f1158ea444ca.hot-update.js.map